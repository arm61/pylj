...
- The documentation is a set of executed chapters on molecular dynamics, Monte Carlo and the ideal gas law, written to be read like a textbook and built with myst-nb (#85, #58).
