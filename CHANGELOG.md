...
- The radial distribution function pane plots r in Angstrom and the molecular dynamics series panes plot time in picoseconds; the panes previously used metres and seconds.
