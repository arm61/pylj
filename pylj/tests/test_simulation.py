...
from pylj import pairwise, simulation
...
class TestPlacement(unittest.TestCase):
    def test_square_fills_the_lattice_in_order(self):
        c = simulation.place_square(2, (ARGON,), 8e-10)
    ...
    def test_square_assigns_species_in_turn(self):
        c = simulation.place_square(5, (ARGON, LARGER), 30e-10)
    ...
    def test_metropolis_too_dense_raises(self):
        with self.assertRaisesRegex(ValueError, f"after {simulation.PLACEMENT_ATTEMPTS} attempts"):
            place(200, 100, 20, init_conf="metropolis")
